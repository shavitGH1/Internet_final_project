...
router
    .route('/')
    .get(recipeController_1.default.get.bind(recipeController_1.default)) // שונה מ-getAllRecipes
    .post(recipeController_1.default.post.bind(recipeController_1.default)); // שונה מ-createRecipe
router
    .route('/:id')
